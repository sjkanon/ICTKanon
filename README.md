...
- ✅ Added partnership reference to AVH Tech for telefonie services
- ✅ Telefonie page now includes link to https://www.avhtech.nl/telefonie/
- ✅ All styling now unified across all pages with no extra detail-page CSS
